...
HD_PWD='D:/SEA-master/Examples/FPGA/4.Module-Interface/DAC-Interface/DAC_Demo/DAC_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_Demo.tcl
