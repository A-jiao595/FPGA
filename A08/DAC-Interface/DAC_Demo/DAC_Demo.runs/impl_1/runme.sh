...
HD_PWD='D:/SEA-master/Examples/FPGA/4.Module-Interface/DAC-Interface/DAC_Demo/DAC_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DAC_Demo.tcl -notrace
